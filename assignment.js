...
console.log("\nQuestion 1:-")
console.log(isAnagram('kewal','walek')); //true
...
function findLargestElement(numbers){
    ...
    return Math.max(...numbers) // Math function used here
}

numbers = [12,43,67,23,78];
...
console.log(isPalindrome("paper")) //false
//-----------------------------------------------------------------


//Q5.----------------------------------------------------------------
function calculateTime(n){
    const startTime = performance.now();       //save current time in startTime
...
console.log("\nQuestion 6:-");
console.log("Total vowels = "+countVowels("Hello World")); // answer will be 3
//-----------------------------------------------------------------
...
function filterEvenNumbers(numbers){
    ...
    for(const num of numbers){
        if(num%2 === 0){
            evenNum.push(num);  // Filtering and pushing element in Array
        }
    }
    return evenNum;
}
...
function findSmallestElement(numbers){
    ...
    return Math.min(...numbers);  // Math function used here
}
...
function fibonacci(n){
    if (n===0) return 0;
    if (n===1) return 1;
    return fibonacci(n-1)+fibonacci(n-2);  // used Recursion concept
}
console.log("\nQuestion 11:-");
